...
<style>
  ...
  .btn{
    ...
    box-shadow: 0 0 24px rgba(255,77,136,.55), 0 0 48px rgba(255,122,61,.35);
...
<!-- Векторная сцена: космос + ноутбук + ракета (без водяных знаков) -->
<svg class="scene art" viewBox="0 0 390 844" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
  ...
  <g opacity=".35">
    ...
    <circle cx="120" cy="60" r="1.8" fill="#c8a1ff"/>
